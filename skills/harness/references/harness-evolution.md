# 하네스 진화 — 피드백 반영 · 변경 이력 · 운영/유지보수

SKILL.md Phase 7의 상세. **하네스 실행이 끝난 뒤** 또는 **기존 하네스의 점검·수정·동기화 요청**(Phase 0의 "운영/유지보수" 분기)에서 읽는다. 신규 구축 중에는 읽지 않아도 된다.

## 목차

1. [실행 후 피드백 수집](#7-1-실행-후-피드백-수집)
2. [피드백 반영 경로](#7-2-피드백-반영-경로)
3. [변경 이력](#7-3-변경-이력)
4. [진화 트리거](#7-4-진화-트리거)
5. [운영/유지보수 워크플로우](#7-5-운영유지보수-워크플로우)
